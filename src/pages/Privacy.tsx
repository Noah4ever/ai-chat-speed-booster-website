      ...
      <div className="container">
        <div className={styles.inner}>
          ...
          <article className={styles.doc}>
            ...
            <p>
              This policy applies to the AI Chat Speed Booster website, the
              page you are reading now. The AI Chat Speed Booster browser
              extension is a separate program with its own behavior; see{" "}
            ...
            <p>
              ...
              , an open-source, privacy-focused analytics tool. It is
              self-hosted on the same infrastructure as this website, so your
              visit is not shared with Google Analytics or any third-party
              analytics company.
            </p>
            <p>
              Umami is cookie-free and collects no personal information. It
              cannot identify you and never tracks you across other websites.
              For each visit it records only aggregate, non-identifying
              details:
            </p>
            <ul>
            ...
            <p>
              There are no user accounts, no visitor profiles, and no
            ...
            <ul>
              ...
              <li>
                the Safari install guide and demo content, fetched live from
                the project&rsquo;s repository
              </li>
            </ul>
            <p>
              When this happens, GitHub receives a normal web request,
              ...
              Add-ons; if you click them you visit those sites, which have
            ...
            <p>
              ...
              does not receive any data from the extension. Because the
              extension is open source, you can review exactly what it does in
              its{" "}
            ...
            <h2>Data sharing</h2>
            <p>
              Data collected by this website is never sold, rented, or shared
              for advertising. Aggregate analytics data stays on infrastructure
            ...
            <p>
              If this policy changes, the &ldquo;last updated&rdquo; date near
